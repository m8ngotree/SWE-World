...
def run_ppo_agent(config):
    if not ray.is_initialized():
        ...
        print("初始化一下ray"*100)
        ray.init(runtime_env={"pip": ["sentence_transformers",'polars', "fastcore==1.5.29", "ghapi==1.0.3", "swebench==3.0.2","dm-tree","gym>=0.26.2","kubernetes>=32.0.1","fire",
        "swe_world/new_packages/swebench_fork_swegym-2.0.13-py3-none-any.whl",
        "swe_world/new_packages/swebench_fork_swerebench-4.0.3-py3-none-any.whl",
        "swe_world/new_packages/swesmith-0.0.7-py3-none-any.whl","simple-parsing>=0.1.6",
        ...
        "seaborn>=0.13.2","orjson>=3.10.18","gpustat>=1.1.1"],
            ...
            "env_vars": {"TOKENIZERS_PARALLELISM": "true", "NCCL_DEBUG": "WARN", "PYTHONPATH": "DeepSWE_RL/rllm"}})
